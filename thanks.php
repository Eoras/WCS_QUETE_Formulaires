...
<body>
    ...
    <div id="success">
        ...
        Merci <?php echo $FORM['user_firstname'] . " " . $FORM['user_lastname']; ?> de nous avoir contacté à propos de “<?php echo ucfirst ( $FORM['user_theme']); ?>”.
        <br>
        Un de nos conseiller vous contactera soit à l’adresse <?php echo $FORM['user_email']; ?> ou par téléphone au <?php echo $FORM['user_phone']; ?> dans les plus brefs délais pour traiter votre demande :
        <br>
        <?php echo $FORM['user_message']; ?>
